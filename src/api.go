...
func src_api_file_wren() (*asset, error) {
	...
	info := bindata_file_info{name: "src/api/file.wren", size: 198, mode: os.FileMode(420), modTime: time.Unix(1421273018, 0)}
...
func src_api_main_wren() (*asset, error) {
	...
	info := bindata_file_info{name: "src/api/main.wren", size: 11, mode: os.FileMode(420), modTime: time.Unix(1421273018, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
...
func src_api_markdown_wren() (*asset, error) {
	...
	info := bindata_file_info{name: "src/api/markdown.wren", size: 318, mode: os.FileMode(420), modTime: time.Unix(1421273018, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
